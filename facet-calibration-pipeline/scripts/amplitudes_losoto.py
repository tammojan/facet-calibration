...
bad_sblist   = [] # run first with all subbands, 
                  # then determine which subbands are bad based on the plots and set "bad_sblist" accordingly and re-run (some trial and error will be needed)
#bad_sblist   = [302, 300, 343,344,345,346,347,348,349, 361,362,363]
